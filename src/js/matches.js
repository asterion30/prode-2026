...
MOCK_MATCHES.push({ id: "m_Catar_Suiza", stage: "groups", homeTeam: "Catar", awayTeam: "Suiza", matchDate: "2026-06-13T15:00:00-04:00", homeFlag: "qa", awayFlag: "ch", status: "pending", tbd: false });
MOCK_MATCHES.push({ id: "m_Brasil_Marruecos", stage: "groups", homeTeam: "Brasil", awayTeam: "Marruecos", matchDate: "2026-06-13T18:00:00-04:00", homeFlag: "br", awayFlag: "ma", status: "pending", tbd: false });
MOCK_MATCHES.push({ id: "m_Haití_Escocia", stage: "groups", homeTeam: "Haití", awayTeam: "Escocia", matchDate: "2026-06-13T21:00:00-04:00", homeFlag: "ht", awayFlag: "gb-sct", status: "pending", tbd: false });
MOCK_MATCHES.push({ id: "m_Australia_Turquía", stage: "groups", homeTeam: "Australia", awayTeam: "Turquía", matchDate: "2026-06-14T00:00:00-04:00", homeFlag: "au", awayFlag: "tr", status: "pending", tbd: false });
...
MOCK_MATCHES.push({ id: "m_Austria_Jordania", stage: "groups", homeTeam: "Austria", awayTeam: "Jordania", matchDate: "2026-06-17T00:00:00-04:00", homeFlag: "at", awayFlag: "jo", status: "pending", tbd: false });
MOCK_MATCHES.push({ id: "m_Portugal_RDCongo", stage: "groups", homeTeam: "Portugal", awayTeam: "RD Congo", matchDate: "2026-06-17T14:00:00-04:00", homeFlag: "pt", awayFlag: "cd", status: "pending", tbd: false });
MOCK_MATCHES.push({ id: "m_Inglaterra_Croacia", stage: "groups", homeTeam: "Inglaterra", awayTeam: "Croacia", matchDate: "2026-06-17T16:00:00-04:00", homeFlag: "gb-eng", awayFlag: "hr", status: "pending", tbd: false });
MOCK_MATCHES.push({ id: "m_Ghana_Panamá", stage: "groups", homeTeam: "Ghana", awayTeam: "Panamá", matchDate: "2026-06-17T19:00:00-04:00", homeFlag: "gh", awayFlag: "pa", status: "pending", tbd: false });
MOCK_MATCHES.push({ id: "m_Uzbekistán_Colombia", stage: "groups", homeTeam: "Uzbekistán", awayTeam: "Colombia", matchDate: "2026-06-17T22:00:00-04:00", homeFlag: "uz", awayFlag: "co", status: "pending", tbd: false });
...
MOCK_MATCHES.push({ id: "m_Turquía_Paraguay", stage: "groups", homeTeam: "Turquía", awayTeam: "Paraguay", matchDate: "2026-06-19T23:00:00-04:00", homeFlag: "tr", awayFlag: "py", status: "pending", tbd: false });
MOCK_MATCHES.push({ id: "m_PaísesBajos_Suecia", stage: "groups", homeTeam: "Países Bajos", awayTeam: "Suecia", matchDate: "2026-06-20T13:00:00-04:00", homeFlag: "nl", awayFlag: "se", status: "pending", tbd: false });
MOCK_MATCHES.push({ id: "m_Alemania_CostadeMarfil", stage: "groups", homeTeam: "Alemania", awayTeam: "Costa de Marfil", matchDate: "2026-06-20T16:00:00-04:00", homeFlag: "de", awayFlag: "ci", status: "pending", tbd: false });
MOCK_MATCHES.push({ id: "m_Ecuador_Curazao", stage: "groups", homeTeam: "Ecuador", awayTeam: "Curazao", matchDate: "2026-06-20T20:00:00-04:00", homeFlag: "ec", awayFlag: "cw", status: "pending", tbd: false });
MOCK_MATCHES.push({ id: "m_Túnez_Japón", stage: "groups", homeTeam: "Túnez", awayTeam: "Japón", matchDate: "2026-06-20T23:00:00-04:00", homeFlag: "tn", awayFlag: "jp", status: "pending", tbd: false });
MOCK_MATCHES.push({ id: "m_España_ArabiaSaudí", stage: "groups", homeTeam: "España", awayTeam: "Arabia Saudí", matchDate: "2026-06-21T12:00:00-04:00", homeFlag: "es", awayFlag: "sa", status: "finished", homeGoals: "4", awayGoals: "0", tbd: false });
MOCK_MATCHES.push({ id: "m_Bélgica_Irán", stage: "groups", homeTeam: "Bélgica", awayTeam: "RI de Irán", matchDate: "2026-06-21T15:00:00-04:00", homeFlag: "be", awayFlag: "ir", status: "pending", tbd: false });
...
MOCK_MATCHES.push({ id: "m_Francia_Irak", stage: "groups", homeTeam: "Francia", awayTeam: "Irak", matchDate: "2026-06-22T21:00:00-04:00", homeFlag: "fr", awayFlag: "iq", status: "pending", tbd: false });
...
MOCK_MATCHES.push({ id: "m_Jordania_Argelia", stage: "groups", homeTeam: "Jordania", awayTeam: "Argelia", matchDate: "2026-06-22T23:00:00-04:00", homeFlag: "jo", awayFlag: "dz", status: "finished", homeGoals: "1", awayGoals: "2", tbd: false });
...
MOCK_MATCHES.push({ id: "m_Colombia_RDCongo", stage: "groups", homeTeam: "Colombia", awayTeam: "RD Congo", matchDate: "2026-06-23T22:00:00-04:00", homeFlag: "co", awayFlag: "cd", status: "finished", homeGoals: "1", awayGoals: "0", tbd: false });
MOCK_MATCHES.push({ id: "m_Suiza_Canadá", stage: "groups", homeTeam: "Suiza", awayTeam: "Canadá", matchDate: "2026-06-24T15:00:00-04:00", homeFlag: "ch", awayFlag: "ca", status: "pending", tbd: false });
MOCK_MATCHES.push({ id: "m_BosniayHerzegovina_Catar", stage: "groups", homeTeam: "Bosnia y Herzegovina", awayTeam: "Catar", matchDate: "2026-06-24T22:00:00-04:00", homeFlag: "ba", awayFlag: "qa", status: "pending", tbd: false });
MOCK_MATCHES.push({ id: "m_Escocia_Brasil", stage: "groups", homeTeam: "Escocia", awayTeam: "Brasil", matchDate: "2026-06-24T18:00:00-04:00", homeFlag: "gb-sct", awayFlag: "br", status: "pending", tbd: false });
MOCK_MATCHES.push({ id: "m_Marruecos_Haití", stage: "groups", homeTeam: "Marruecos", awayTeam: "Haití", matchDate: "2026-06-24T18:00:00-04:00", homeFlag: "ma", awayFlag: "ht", status: "pending", tbd: false });
MOCK_MATCHES.push({ id: "m_RepúblicaCheca_México", stage: "groups", homeTeam: "República Checa", awayTeam: "México", matchDate: "2026-06-24T21:00:00-04:00", homeFlag: "cz", awayFlag: "mx", status: "pending", tbd: false });
MOCK_MATCHES.push({ id: "m_Sudáfrica_RepúblicadeCorea", stage: "groups", homeTeam: "Sudáfrica", awayTeam: "República de Corea", matchDate: "2026-06-24T21:00:00-04:00", homeFlag: "za", awayFlag: "kr", status: "pending", tbd: false });
...
MOCK_MATCHES.push({ id: "m_Egipto_Irán", stage: "groups", homeTeam: "Egipto", awayTeam: "RI de Irán", matchDate: "2026-06-26T23:00:00-04:00", homeFlag: "eg", awayFlag: "ir", status: "pending", tbd: false });
...
MOCK_MATCHES.push({ id: "m_Panamá_Inglaterra", stage: "groups", homeTeam: "Panamá", awayTeam: "Inglaterra", matchDate: "2026-06-27T17:00:00-04:00", homeFlag: "pa", awayFlag: "gb-eng", status: "pending", tbd: false });
MOCK_MATCHES.push({ id: "m_Croacia_Ghana", stage: "groups", homeTeam: "Croacia", awayTeam: "Ghana", matchDate: "2026-06-27T17:00:00-04:00", homeFlag: "hr", awayFlag: "gh", status: "pending", tbd: false });
MOCK_MATCHES.push({ id: "m_Colombia_Portugal", stage: "groups", homeTeam: "Colombia", awayTeam: "Portugal", matchDate: "2026-06-27T21:00:00-04:00", homeFlag: "co", awayFlag: "pt", status: "pending", tbd: false });
MOCK_MATCHES.push({ id: "m_RDCongo_Uzbekistán", stage: "groups", homeTeam: "RD Congo", awayTeam: "Uzbekistán", matchDate: "2026-06-27T19:30:00-04:00", homeFlag: "cd", awayFlag: "uz", status: "pending", tbd: false });
MOCK_MATCHES.push({ id: "m_Argelia_Austria", stage: "groups", homeTeam: "Argelia", awayTeam: "Austria", matchDate: "2026-06-27T22:00:00-04:00", homeFlag: "dz", awayFlag: "at", status: "pending", tbd: false });
MOCK_MATCHES.push({ id: "m_Jordania_Argentina", stage: "groups", homeTeam: "Jordania", awayTeam: "Argentina", matchDate: "2026-06-27T22:00:00-04:00", homeFlag: "jo", awayFlag: "ar", status: "pending", tbd: false });
MOCK_MATCHES.push({ id: "m73", stage: "round_32", homeTeam: "Sudáfrica", awayTeam: "Canadá", matchDate: "2026-06-28T15:00:00-04:00", homeFlag: "za", awayFlag: "ca", status: "pending", tbd: false });
MOCK_MATCHES.push({ id: "m74", stage: "round_32", homeTeam: "Alemania", awayTeam: "3º Grupo A/B/C/D/F", matchDate: "2026-06-29T16:30:00-04:00", homeFlag: "de", awayFlag: "un", status: "pending", tbd: true });
MOCK_MATCHES.push({ id: "m75", stage: "round_32", homeTeam: "Países Bajos", awayTeam: "Marruecos", matchDate: "2026-06-29T21:00:00-04:00", homeFlag: "nl", awayFlag: "ma", status: "pending", tbd: false });
MOCK_MATCHES.push({ id: "m76", stage: "round_32", homeTeam: "Brasil", awayTeam: "Japón", matchDate: "2026-06-29T13:00:00-04:00", homeFlag: "br", awayFlag: "jp", status: "pending", tbd: false });
MOCK_MATCHES.push({ id: "m77", stage: "round_32", homeTeam: "1º Grupo I", awayTeam: "3º Grupo C/D/F/G/H", matchDate: "2026-06-30T17:00:00-04:00", homeFlag: "un", awayFlag: "un", status: "pending", tbd: true });
MOCK_MATCHES.push({ id: "m78", stage: "round_32", homeTeam: "Costa de Marfil", awayTeam: "2º Grupo I", matchDate: "2026-06-30T13:00:00-04:00", homeFlag: "ci", awayFlag: "un", status: "pending", tbd: true });
MOCK_MATCHES.push({ id: "m79", stage: "round_32", homeTeam: "México", awayTeam: "3º Grupo C/E/F/H/I", matchDate: "2026-06-30T21:00:00-04:00", homeFlag: "mx", awayFlag: "un", status: "pending", tbd: true });
MOCK_MATCHES.push({ id: "m80", stage: "round_32", homeTeam: "1º Grupo L", awayTeam: "3º Grupo E/H/I/J/K", matchDate: "2026-07-01T12:00:00-04:00", homeFlag: "un", awayFlag: "un", status: "pending", tbd: true });
MOCK_MATCHES.push({ id: "m81", stage: "round_32", homeTeam: "1º Grupo D", awayTeam: "3º Grupo B/E/F/I/J", matchDate: "2026-07-01T20:00:00-04:00", homeFlag: "un", awayFlag: "un", status: "pending", tbd: true });
MOCK_MATCHES.push({ id: "m82", stage: "round_32", homeTeam: "1º Grupo G", awayTeam: "3º Grupo A/E/H/I/J", matchDate: "2026-07-01T16:00:00-04:00", homeFlag: "un", awayFlag: "un", status: "pending", tbd: true });
